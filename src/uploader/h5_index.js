...
// 模板
var itemTemp = require('./template/index.art');
var inputTemp = require('./template/input.art');
...
function Uploader(elem, opts) {
    this.option = $.extend(Uploader.defaults, opts);
    this.init();
    this.$elem = $(elem);
}
...
Uploader.prototype = {
    ...
    init: function() {
        ...
        var str = inputTemp({
        	...
        	multi: option.multi,
        	fileTypeExts: getFileTypes(option.fileTypeExts),
